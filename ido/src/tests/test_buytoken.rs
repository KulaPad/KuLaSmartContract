...
fn test_buy_token() {
    ...
    emulator.contract.commit("bob".to_string(),1,"ft_contract".to_string(),U128(25));
    emulator.contract.commit("bob".to_string(),2,"ft_contract".to_string(),U128(25));
    ...
    emulator.update_context("alice".to_string(), "bob".to_string(), 20_000_000_000_000);
    emulator.set_block_timestamp(1651804401000000000);
    emulator.contract.commit("bob".to_string(),2,"ft_contract".to_string(),U128(30));
