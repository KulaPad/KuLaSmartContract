...
fn test_buy_token() {
    ...
    emulator.contract.update_account_sale_ticket("bob".to_string(), 2, 6);
    ...
    let mut default_lottery_project_account_sale = AccountSale{
        committed_amount: 20_000_000_000_000_000_000_000_000,
    ...
    emulator.contract.commit(1);
    emulator.contract.commit(2);
    ...
    emulator.update_context("alice".to_string(), "bob".to_string(), 30_000_000_000_000_000_000_000_000);
    emulator.set_block_timestamp(1651804401000000000);
    emulator.contract.commit(2);
    ...
    default_lottery_project_account_sale = AccountSale{
        committed_amount:50_000_000_000_000_000_000_000_000,
        sale_data: AccountSaleData::Lottery(
            LotteryAccountSaleData{
                eligible_tickets: 6,
                deposit_tickets: 5,
